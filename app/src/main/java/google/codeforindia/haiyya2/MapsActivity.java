package google.codeforindia.haiyya2;
...
public class MapsActivity extends FragmentActivity {
    ...
    Location loc;// Might be null if Google Play services APK is not available.
            ...
            mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
                ...
                public boolean onMarkerClick(Marker marker) {
                    ...
                    title=title.substring(0,title.indexOf('|')-1);
                        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("google.navigation:q=" + loc.getLatitude() + "," + loc.getLongitude()));
